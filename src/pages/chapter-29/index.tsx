...
import "./chapter-29.css"
import { TABS, TOPIC_META, TOPICS } from "./data"
import { CHAIN_OF_THOUGHT_TABS } from "./topics/chain-of-thought/tabs"
import { SELF_CONSISTENCY_TABS } from "./topics/self-consistency/tabs"
import { TREE_OF_THOUGHTS_TABS } from "./topics/tree-of-thoughts/tabs"
import { PROCESS_REWARDS_TABS } from "./topics/process-rewards/tabs"
import type { TabId, TopicId } from "./types"

const TAB_IDS = TABS.map((t) => t.id)

export function Chapter29Page() {
    ...
    const tabContent: Record<TopicId, React.ReactNode> = {
        "chain-of-thought":  CHAIN_OF_THOUGHT_TABS[activeTab],
        "self-consistency":  SELF_CONSISTENCY_TABS[activeTab],
        "tree-of-thoughts":  TREE_OF_THOUGHTS_TABS[activeTab],
        "process-rewards":   PROCESS_REWARDS_TABS[activeTab],
    }

    return (
        <div className="ch">
            <header className="ch-header">
                <Link to="/" style={{ textDecoration: 'none' }}><span className="ch-header-chapter">Ch. 29</span></Link>
                <div className="ch-header-sep" />
                <span className="ch-header-title">Reasoning &amp; Chain-of-Thought</span>
