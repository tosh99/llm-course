...
import "./chapter-24.css"
import { TABS, TOPIC_META, TOPICS } from "./data"
import { EMERGENT_ABILITIES_TABS } from "./topics/emergent-abilities/tabs"
import { CHINCHILLA_SCALING_TABS } from "./topics/chinchilla-scaling/tabs"
import { PHASE_TRANSITIONS_TABS } from "./topics/phase-transitions/tabs"
...
export function Chapter24Page() {
    ...
    const tabContent: Record<TopicId, React.ReactNode> = {
        ...
        "chinchilla-scaling":  CHINCHILLA_SCALING_TABS[activeTab],
        "phase-transitions":   PHASE_TRANSITIONS_TABS[activeTab],
    }

    return (
        <div className="ch">
            <header className="ch-header">
                <Link to="/" style={{ textDecoration: 'none' }}><span className="ch-header-chapter">Ch. 24</span></Link>
                <div className="ch-header-sep" />
                <span className="ch-header-title">Emergent Abilities &amp; Chinchilla</span>
