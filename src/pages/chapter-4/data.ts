...
export const TOPICS: { id: TopicId; label: string; icon: string; category: string; ready: boolean }[] = [
    { id: "backpropagation", label: "Backpropagation", icon: "⇄", category: "Core Algorithm", ready: true },
    { id: "mlp", label: "Multi-layer Perceptrons", icon: "◎", category: "Architecture", ready: true },
...
export const TOPIC_META: Record<TopicId, { eyebrow: string; subtitle: string }> = {
    backpropagation: {
        ...
        subtitle: "The chain rule of calculus applied recursively — how networks actually learn",
    },
    mlp: {
    ...
    "activation-functions": {
        eyebrow: "Chapter 4 · Architecture",
        subtitle: "Sigmoid, tanh, and why non-linearity is the soul of deep networks",
    },
    "gradient-descent": {
        eyebrow: "Chapter 4 · Training",
        subtitle: "Batch, stochastic, and mini-batch — three ways to follow the slope downhill",
    },
    "vanishing-gradients": {
        eyebrow: "Chapter 4 · Training",
