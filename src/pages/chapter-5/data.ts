...
export const TOPIC_META: Record<TopicId, { eyebrow: string; subtitle: string }> = {
    "simple-rnn": {
        ...
        subtitle: "Adding memory to neural networks — Elman and Jordan recurrent architectures",
    },
    bptt: {
        eyebrow: "Chapter 5 · Training",
        subtitle: "Unrolling time: how gradients flow backwards through sequence steps",
    },
    "vanishing-gradient": {
        eyebrow: "Chapter 5 · Training",
        subtitle: "Why RNNs forget: the curse of exponentially decaying gradients in deep sequences",
    },
    lstm: {
        eyebrow: "Chapter 5 · Architecture",
        subtitle: "Hochreiter & Schmidhuber's gating solution — letting the network decide what to remember",
    },
}
