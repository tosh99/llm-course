...
import "./chapter-28.css"
import { TABS, TOPIC_META, TOPICS } from "./data"
import { ROPE_TABS } from "./topics/rope/tabs"
import { FLASH_ATTENTION_TABS } from "./topics/flash-attention/tabs"
import { GQA_MQA_TABS } from "./topics/gqa-mqa/tabs"
import { MIXTURE_OF_EXPERTS_TABS } from "./topics/mixture-of-experts/tabs"
import { KV_CACHE_TABS } from "./topics/kv-cache/tabs"
import type { TabId, TopicId } from "./types"

const TAB_IDS = TABS.map((t) => t.id)

export function Chapter28Page() {
    ...
    const tabContent: Record<TopicId, React.ReactNode> = {
        "rope":                 ROPE_TABS[activeTab],
        "flash-attention":      FLASH_ATTENTION_TABS[activeTab],
        "gqa-mqa":              GQA_MQA_TABS[activeTab],
        "mixture-of-experts":   MIXTURE_OF_EXPERTS_TABS[activeTab],
        "kv-cache":             KV_CACHE_TABS[activeTab],
    }

    return (
        <div className="ch">
            <header className="ch-header">
                <Link to="/" style={{ textDecoration: 'none' }}><span className="ch-header-chapter">Ch. 28</span></Link>
                <div className="ch-header-sep" />
                <span className="ch-header-title">Transformer Architecture Advances</span>
