...
import "./chapter-26.css"
import { TABS, TOPIC_META, TOPICS } from "./data"
import { CLIP_TABS } from "./topics/clip/tabs"
import { DALL_E_TABS } from "./topics/dall-e/tabs"
import { FLAMINGO_TABS } from "./topics/flamingo/tabs"
import type { TabId, TopicId } from "./types"

const TAB_IDS = TABS.map((t) => t.id)

export function Chapter26Page() {
    ...
    const tabContent: Record<TopicId, React.ReactNode> = {
        "clip":    CLIP_TABS[activeTab],
        "dall-e":  DALL_E_TABS[activeTab],
        "flamingo": FLAMINGO_TABS[activeTab],
    }

    return (
        <div className="ch">
            <header className="ch-header">
                <Link to="/" style={{ textDecoration: 'none' }}><span className="ch-header-chapter">Ch. 26</span></Link>
                <div className="ch-header-sep" />
                <span className="ch-header-title">Multimodal Models &mdash; Vision &amp; Language</span>
