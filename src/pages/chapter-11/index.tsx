...
import { VAE_TABS } from "./topics/variational-autoencoders/tabs"
import { GANS_TABS } from "./topics/gans/tabs"
import { CONDITIONAL_GANS_TABS } from "./topics/conditional-gans/tabs"
...
export function Chapter11Page() {
    ...
    const tabContent: Record<TopicId, React.ReactNode> = {
        "variational-autoencoders": VAE_TABS[activeTab],
        gans:                       GANS_TABS[activeTab],
        "conditional-gans":         CONDITIONAL_GANS_TABS[activeTab],
    }
    ...
    return (
        <div className="ch">
            ...
            <header className="ch-header">
                ...
                <span className="ch-header-title">Generative Models</span>
