    ...
    return (
        <>
            ...
            <Analogy label="What comes next — a completely different way to see">
                RNNs and BiRNNs process sequences step by step. But a completely separate tradition was developing in parallel: networks that processed space rather than time — looking at local patches of an image and combining them into a hierarchy of features. That tradition, beginning with LeCun's 1989 paper and reaching its landmark at LeNet-5 in 1998, is Chapter 7: Convolutional Neural Networks.
            </Analogy>
        </>
    )
}
