...
function HistoryTab() {
    const items: TlItem[] = [
        {
            year: "1986",
            title: "Jordan, Elman & the Birth of Memory in Neural Networks",
            challenge:
                "Chapter 5 showed that backpropagation could train networks on fixed-size inputs — images, feature vectors, single data points. But language, speech, and time series are fundamentally different: meaning depends on sequence. The word 'not' changes everything that follows it; a musical note only makes sense in the context of what came before. Feedforward networks, applied to sequences one timestep at a time, had no way to carry context forward.",
