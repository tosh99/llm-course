...
import { SHANNON_INFORMATION_THEORY_TABS } from "./topics/shannon-information-theory/tabs"
...
export function Chapter2Page() {
    ...
    const tabContent: Record<TopicId, React.ReactNode> = {
        ...
        "shannon-information-theory": SHANNON_INFORMATION_THEORY_TABS[activeTab],
    ...
    return (
        <div className="ch">
            ...
            <header className="ch-header">
                ...
                <span className="ch-header-title">Neural Origins &amp; Information Theory</span>
