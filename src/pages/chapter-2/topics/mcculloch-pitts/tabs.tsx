    ...
    return (
        <>
            ...
            <p className="ch-story-intro">
                Chapter 1 traced the statisticians: Gauss, Pearson, Fisher, Cox — people who built mathematical models of data using equations they designed by hand. Chapter 2 follows a completely different group. In 1943, a neurophysiologist and a teenager asked: what if instead of designing the equations, we copied the brain?
            </p>
