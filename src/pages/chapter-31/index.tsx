    ...
    return (
        <div className="ch">
            ...
            <header className="ch-header">
                <Link to="/" style={{ textDecoration: 'none' }}><span className="ch-header-chapter">Ch. 31</span></Link>
                <div className="ch-header-sep" />
                <span className="ch-header-title">Open LLMs</span>
