    ...
    },
    {
        ...
        chapters: [
            ...
            },
            {
                ...
                era: "1960s – 2000s",
                topics: ["k-Means", "PCA", "Gaussian Mixtures", "EM Algorithm", "Autoencoders"],
            },
        ],
    },
    {
        ...
        chapters: [
            {
                ...
                era: "1986",
                topics: ["Backprop", "MLP", "Sigmoid / Tanh", "Vanishing Gradients", "Universal Approximation"],
            },
            {
                num: "Ch. 5",
                title: "Recurrent Neural Networks",
                era: "1986 – 1997",
                topics: ["Elman / Jordan RNN", "BPTT", "LSTM", "GRU", "Language Modeling"],
            },
            {
                num: "Ch. 6",
        ...
        chapters: [
            {
                ...
                era: "2006 – 2012",
                topics: ["Deep Belief Nets", "RBMs", "ReLU", "Dropout", "AlexNet"],
            },
            {
                num: "Ch. 8",
            ...
            },
            {
                ...
                era: "2013 – 2015",
                topics: ["Word2Vec", "GloVe", "FastText", "Embeddings", "Analogies"],
            },
        ],
    },
    {
        ...
        chapters: [
            {
                ...
                era: "2014",
                topics: ["Seq2Seq", "LSTM Encoder-Decoder", "Machine Translation", "Teacher Forcing"],
            },
            {
                num: "Ch. 12",
    ...
    },
    {
        ...
        chapters: [
            ...
            },
            {
                ...
                era: "2022 – 2023",
                topics: ["LLaMA", "Mistral 7B", "LoRA", "QLoRA", "Instruction Tuning"],
            },
            {
                num: "Ch. 22",
