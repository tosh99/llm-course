    ...
    return (
        <>
            ...
            <div className="ch-callout">
                ...
                a failure of prerequisites. While CNNs waited for their moment, a parallel tradition was
                reaching its peak: statistical methods — SVMs, AdaBoost, Random Forests — that required
                no raw-pixel learning at all. Chapter 8 covers that golden age of classical ML, from the
                kernel trick (1992) to Random Forests (2001).
            </div>
        </>
    )
}
    ...
    return (
        <>
            ...
            <div className="ch-callout">
                ...
                suit actually works!" But we're getting ahead of ourselves — that story is Chapter 9.
                First: Chapter 8, where a completely different group of algorithms dominated the years
                when CNNs were sleeping. While neural networks waited, SVMs and Random Forests ruled.
            </div>
        </>
    )
}
